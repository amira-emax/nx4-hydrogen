...
> & {
  ...
  birthDate?: CustomerAccountAPI.Maybe<
    Pick<CustomerAccountAPI.Metafield, 'value'>
  >;
  emailMarketingConsent?: CustomerAccountAPI.Maybe<
    Pick<CustomerAccountAPI.Metafield, 'value'>
  >;
  personalizedUpdateConsent?: CustomerAccountAPI.Maybe<
    Pick<CustomerAccountAPI.Metafield, 'value'>
  >;
};
...
export type MetafieldsSetMutation = {
  metafieldsSet?: CustomerAccountAPI.Maybe<{
    metafields?: CustomerAccountAPI.Maybe<
      Array<
        Pick<CustomerAccountAPI.Metafield, 'id' | 'namespace' | 'key' | 'value'>
      >
    >;
    userErrors: Array<
      Pick<
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  fragment OrderMoney on MoneyV2 {\n    amount\n    currencyCode\n  }\n  fragment DiscountApplication on DiscountApplication {\n    value {\n      __typename\n      ... on MoneyV2 {\n        ...OrderMoney\n      }\n      ... on PricingPercentageValue {\n        percentage\n      }\n    }\n  }\n  fragment OrderLineItemFull on LineItem {\n    id\n    title\n    quantity\n    price {\n      ...OrderMoney\n    }\n    # TODO: Uncomment when Shopify fixes Customer Account API discountAllocations bug\n    # https://community.shopify.dev/t/customer-account-query-internal-errors/28116/2\n    # Bug causes internal errors for checkout-created orders\n    # discountAllocations {\n    #   allocatedAmount {\n    #     ...OrderMoney\n    #   }\n    #   discountApplication {\n    #     ...DiscountApplication\n    #   }\n    # }\n    totalDiscount {\n      ...OrderMoney\n    }\n    image {\n      altText\n      height\n      url\n      id\n      width\n    }\n    variantTitle\n  }\n  fragment Order on Order {\n    id\n    name\n    confirmationNumber\n    statusPageUrl\n    fulfillmentStatus\n    processedAt\n    fulfillments(first: 1) {\n      nodes {\n        status\n      }\n    }\n    totalTax {\n      ...OrderMoney\n    }\n    totalPrice {\n      ...OrderMoney\n    }\n    subtotal {\n      ...OrderMoney\n    }\n    shippingAddress {\n      name\n      formatted(withName: true)\n      formattedArea\n    }\n    discountApplications(first: 100) {\n      nodes {\n        ...DiscountApplication\n      }\n    }\n    lineItems(first: 100) {\n      nodes {\n        ...OrderLineItemFull\n      }\n    }\n  }\n  query Order($orderId: ID!, $language: LanguageCode)\n    @inContext(language: $language) {\n    order(id: $orderId) {\n      ... on Order {\n        ...Order\n      }\n    }\n  }\n': {
    return: OrderQuery;
