                  ...
                  {urlLabel && (
                    <h3
                      ...
                      className={cn(
                        ...
                        layout === 'center' ? 'pt-10 md:pt-60 pb-5' : 'pt-10 pb-3',
                      )}
                    >
                      {urlLabel}
                      <span>
                        <div className="flex justify-center mt-2">
                          <div className="h-25 md:h-35" style={{width: '0px', borderLeft: '1px solid transparent', borderImageSource: 'linear-gradient(180deg, #FFFFFF 40.38%, rgba(9, 9, 9, 0) 100%)', borderImageSlice: 1}} />
                        </div>
                      </span>
                    </h3>
                  )}
